...
@section('content')
      ...
      <div class="row mt-3 mb-0 mx-2">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Room View </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="room_name" style="cursor: pointer">Room Name 
                <span id="room_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
          <th  width="10%"> Building name </th>
          <th  width="10%"> Floor Name </th>
          <th  width="10%"> Flat Name </th>
          <th  width="35%"> Room Details </th>
		      <th  width="10%"></th>
		      <th  width="10%"></th>
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
            ...
            <div class="col-lg-6 my-2">
                 <label for="roll">Floor  Name<span style="color:red;"> * </span></label>
                 <input type="text" name="floor_name" id="floor_name" class="form-control" placeholder="" required>
            </div>

            <div class="col-lg-6 my-2">
                 <label for="roll">Room Name <span style="color:red;"> * </span></label>
                 <input type="text" name="room_name" id="room_name" class="form-control" placeholder="" required>
            </div>

            <div class="col-lg-6 my-2">
                <label for="roll">Flat Name  </label>
                <input type="text" name="flat_name" id="flat_name" class="form-control" placeholder="" >
            </div>


            <div class="col-lg-12 my-2">
                <label for="roll">Room Details <span style="color:red;"> * </span>  </label>
                <textarea name="room_details" id="room_details" col="10" rows="4"  class="form-control" ></textarea>
            </div>


            <div class="col-lg-12 my-2">
                <label for="roll">Youtube Link  </label>
                <input type="text" name="youtube_link" id="youtube_link" class="form-control" placeholder=""  >
            </div>



            <div class="col-lg-12 my-2">
                <label for="roll"> Image 1 (h:400px*W:600px)<span style="color:red;"> * </span></label>
                <input type="file" name="image1" id="image1" class="form-control" placeholder="" required>
                <p class="text-danger error_image1"></p>
            </div>


            <div class="col-lg-12 my-2">
                <label for="roll"> Image 2 (h:400px*W:600px)</label>
                <input type="file" name="image2" id="image2" class="form-control" placeholder="" >
                <p class="text-danger error_image2"></p>
            </div>

            <div class="col-lg-12 my-2">
                <label for="roll"> Image 3 (h:400px*W:600px)</label>
                <input type="file" name="image3" id="image3" class="form-control" placeholder="" >
                <p class="text-danger error_image3"></p>
            </div>
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
                  <label for="roll">Building  Name<span style="color:red;"> * </span></label>
              <select class="form-select" id="edit_building_id" name="building_id" aria-label="Default select example " required>
                       <option  value="">Select One </option>
                        @foreach($building as $row)
                            <option   value="{{$row->id}}">{{$row->building_name}}</option>
                        @endforeach  
            ...
            <div class="col-lg-6 my-2">
                 <label for="roll">Floor  Name<span style="color:red;"> * </span></label>
                 <input type="text" name="floor_name" id="edit_floor_name" class="form-control" placeholder="" required>
            </div>

            <div class="col-lg-6 my-2">
                 <label for="roll">Room Name <span style="color:red;"> * </span></label>
                 <input type="text" name="room_name" id="edit_room_name" class="form-control" placeholder="" required>
            </div>

            <div class="col-lg-6 my-2">
                <label for="roll">Flat Name  </label>
                <input type="text" name="flat_name" id="edit_flat_name" class="form-control" placeholder="" >
            </div>


            <div class="col-lg-12 my-2">
                <label for="roll">Room Details <span style="color:red;"> * </span>  </label>
                <textarea name="room_details" id="edit_room_details" col="10" rows="4"  class="form-control" ></textarea>
            </div>


            <div class="col-lg-12 my-2">
                <label for="roll">Youtube Link  </label>
                <input type="text" name="youtube_link" id="edit_youtube_link" class="form-control" placeholder=""  >
            </div>



            <div class="col-lg-12 my-2">
                <label for="roll"> Image 1 (h:400px*W:600px) </label>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Room Status</b></label>
                   <select class="form-select" name="room_status" id="edit_room_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/manager/room_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_building_id").val(response.data.building_id);
              $("#edit_floor_name").val(response.data.floor_name);
              $("#edit_room_name").val(response.data.room_name);
              $("#edit_flat_name").val(response.data.flat_name);
              $("#edit_room_details").val(response.data.room_details);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/manager/room/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
