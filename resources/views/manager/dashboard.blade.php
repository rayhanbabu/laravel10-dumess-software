  ...
  <section id="minimal-statistics">
    <div class="row">
      <div class="col-12 mt-3 mb-1">
         <h4 class=""> Current Section : {{$hallinfo->cur_year}}-{{$hallinfo->cur_month}}-{{$hallinfo->cur_section}}.  For any query please contact 01710042765  (palash)    <a href="https://www.youtube.com/watch?v=uOUav1AzENE" target="_blank"> Vedio Tutorial</a></h4>
      </div>
    </div>
    ...
    <div class="row">
      ...
      @php 
            $refund=($invoice->sum('pre_refund')+$exinvoice->sum('pre_refund')+
        ...
        <div class="card shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="media-body text-left">
                  <h3 class="success">{{ $payment2->sum('payble_amount2')-$reserve_payment2 }}TK</h3>
