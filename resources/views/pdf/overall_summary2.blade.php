  ...
  <center>
         ...
         <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="right">{{ $payment2->sum('payble_amount2')-$reserve_payment2 }} TK</td>
              </tr>
           ...
           <table>
            ...
            <tfoot>
              <tr>
                ...
                <td align="right">{{$total_payment+$manager_get+$extra_payment->sum('amount') }} TK</td> 
              </tr>
            </tfoot>
          </table>
    ...
    +($invoice->sum('feast')-$invoice->sum('refund_feast'))) }}TK</td>
            ...
            <tfoot class="text">
              ...
              <tr>
                <td colspan="2">(+Reserve)/(-Extra) Bazar(4-5)</td>
                <td align="right">{{($invoice->sum('onmeal_amount')+($invoice->sum('friday')- $invoice->sum('refund_friday'))
...
<br><br><br> <br><br><br>  <br><br><br> <br><br>
            ...
            <tbody>
              ...
              <tr>
                <td>13</td>
                <td>Admin get</td>
                <td align="right">{{$admin_get}} TK</td>
              </tr>
            ...
            <tfoot class="text">
              <tr>
                ...
                <td align="right">{{ ($total_payment+$extra_payment->sum('amount')+$manager_get)
